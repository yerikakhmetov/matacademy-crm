...
type Values = { name?: string; level?: string; capacity?: number; color?: string; teacherId?: string | null };

export function GroupForm({ teachers, values }: { teachers: Teacher[]; values?: Values }) {
  return (
    <>
      <div className="field">
