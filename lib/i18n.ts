...
const ru = {
  ...
  "common.theme": "Тёмная тема",
  "today.title": "Сегодня",
  "today.noLessons": "Сегодня занятий нет",
  "today.dueSoon": "Скоро сдавать",
  "today.testsOpen": "Можно пройти",
  "today.dueToday": "сегодня",
  "today.dueTomorrow": "завтра",
  ...
  "cabinet.addToCalendar": "В календарь",
  "cabinet.tests": "Тесты",
  ...
  "test.answeredOf": "Отвечено {n} из {total}",
  "test.saving": "сохраняем…",
  "test.autosaveNote": "Ответы сохраняются сразу. Если вкладка закроется, результат посчитается по сохранённым ответам.",
  "test.startTitle": "Тест на время",
  "test.startNote": "На тест даётся {min} мин. Отсчёт начнётся после нажатия кнопки.",
  "test.start": "Начать тест",
  "test.timeUp": "Время вышло — результат посчитан по сохранённым ответам.",
...
const kk: Record<MsgKey, string> = {
  ...
  "common.today": "бүгін",
  "common.language": "Тіл",
  "common.theme": "Қараңғы тақырып",
  "today.title": "Бүгін",
  "today.noLessons": "Бүгін сабақ жоқ",
  "today.dueSoon": "Жақында тапсыру",
  "today.testsOpen": "Тапсыруға болады",
  "today.dueToday": "бүгін",
  "today.dueTomorrow": "ертең",
  ...
  "cabinet.addToCalendar": "Күнтізбеге қосу",
  ...
  "test.submit": "Жіберу",
  "test.answeredOf": "{total} сұрақтың {n} жауабы берілді",
  "test.saving": "сақталуда…",
  "test.autosaveNote": "Жауаптар бірден сақталады. Бет жабылып қалса да, нәтиже сақталған жауаптар бойынша есептеледі.",
  "test.startTitle": "Уақыты шектеулі тест",
  "test.startNote": "Тестке {min} мин беріледі. Уақыт батырманы басқаннан кейін басталады.",
  "test.start": "Тестті бастау",
  "test.timeUp": "Уақыт бітті — нәтиже сақталған жауаптар бойынша есептелді.",
